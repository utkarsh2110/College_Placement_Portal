...
export default function Navbar() {
    ...
    if(location == '/home' || location == '/cvbuilder' || location == '/docs' || location == "/preparation" || location == "/profile" || location == '/changePass'|| location == '/askAdmin' ||  location == '/faq' || location.includes('/admin') && location != ('/admin/login'))
    {
